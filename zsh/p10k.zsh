# Generated by Powerlevel10k configuration wizard on 2024-02-14 at 18:13 -03.
...
typeset -g POWERLEVEL9K_NIX_SHELL_CONTENT_EXPANSION='$(
  if [[ $P9K_CONTENT == *impure* ]]; then
    echo "%F{magenta} %f"
  else
    echo "%F{cyan} %f"
  fi
)'
# typeset -g POWERLEVEL9K_NIX_SHELL_CONTENT_EXPANSION='${P9K_CONTENT//impure/!}'
#   typeset -g POWERLEVEL9K_NIX_SHELL_CONTENT_EXPANSION='
#     [[ $P9K_CONTENT == *impure* ]] && echo "%F{magenta} %f" || echo "%F{cyan} %f"
#   '
# typeset -g POWERLEVEL9K_NIX_SHELL_CONTENT_EXPANSION='[[ $P9K_CONTENT == *impure*]] && "%F{magenta}%f" || "%F{cyan}%f"' 
 #  if [[ $P9K_CONTENT == *impure* ]]; then
 #    echo "%F{magenta}%f"
 #  else
 #    echo "%F{cyan}%f"v
